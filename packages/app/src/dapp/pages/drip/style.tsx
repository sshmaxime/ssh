...
const style = {
  ...
  InfoTitle: styled("span")(({ theme }) => ({
    fontFamily: theme.fontFamily.primary,
    fontSize: "0.8em",
    fontWeight: 300,
  })),
  InfoAnswer: styled("span")(({ theme }) => ({
    fontFamily: theme.fontFamily.primary,
    fontSize: "0.8em",
    fontWeight: 600,
  })),
  ...
  ContainerTitle3: styled("div")(({ theme }) => ({
    fontFamily: theme.fontFamily.primary,
    fontSize: "1.5em",
    color: "black",
    opacity: 0.5,
  ...
  ContainerTitle4: styled("div")(({ theme }) => ({
    fontFamily: theme.fontFamily.primary,
    fontSize: "1.25em",
    color: "black",
    opacity: 0.25,
