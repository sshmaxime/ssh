...
} from "../../../../contracts/mutators/Cryptopunks.sol/CryptopunksMutator";
...
export class CryptopunksMutator__factory extends ContractFactory {
  ...
  override attach(address: string): CryptopunksMutator {
    return super.attach(address) as CryptopunksMutator;
  }
  override connect(signer: Signer): CryptopunksMutator__factory {
